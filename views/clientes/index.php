...
<div class="container mt-5">
    ...
    <div class="row justify-content-center mb-3">
        <form class="col-lg-8 border bg-light p-3">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="cliente_nit">Número de Nit</label>
                    <input type="number" name="cliente_nit" id="cliente_nit" class="form-control" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="cliente_telefono">Número de Teléfono</label>
...
<script defer src="/farmacia/src/js/clientes/index.js"></script>
